  ...
  return (
    <>
      <View style={headingStyles.container}>
        ...
        <Text style={headingStyles.title}>{`${data.id} Parcel List`}</Text>
      </View>
      <FlatList
      ...
      <ReusableBottomSheet
        ...
        <View style={{ width: '100%' }}>
          <CustomTextInput
            ...
            onChangeHandler={(text) => setDriverName(text)}
          />
          <CustomTextInput
            placeholder="License plate"
            onChangeHandler={(text) => setLicensePlate(text)}
          />
        </View>
      </ReusableBottomSheet>
      ...
      <ReusableModal
        ...
        footerBtnText="GO TO PARCEL LIST"
        icon="checkcircleo">
        <Text style={{ maxWidth: '70%', textAlign: 'center' }}>
